  ...
  return Padding(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        const SizedBox(height: 20),
        _buildInfoTile(context, context.watch<AppointmentProvider>().returnGenderImage(), 'Danis'),
        _buildInfoTile(context, 'assets/email.png', context.watch<AppointmentProvider>().appointmentDetails.email,
            onTap: () => context.read<AppointmentProvider>().appointmentDetails.phone.emailTo()),
